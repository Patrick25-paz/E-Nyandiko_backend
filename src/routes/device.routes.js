...
const { createDeviceSchema, getDeviceSchema, grantDeviceExchangeAccessSchema, revokeDeviceExchangeAccessSchema, listDevicesSchema } = require('../validators/device.validator');
